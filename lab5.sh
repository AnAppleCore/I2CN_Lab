...
ip netns exec ns04 ifconfig veth45 up
...
ip netns exec ns05 ifconfig veth56 up
...
ip netns exec ns06 ifconfig veth67 up
...
ip netns exec ns07 ifconfig veth78 up
...
ip netns exec ns08 ifconfig veth89 up
...
ip netns exec ns09 ifconfig veth910 up
...
ip netns exec ns010 ifconfig veth1011 up
...
ip netns exec ns011 ifconfig veth1112 up
...
ip netns exec ns012 ifconfig veth1213 up
...
ip netns exec ns013 ifconfig veth1314 up
...
ip netns exec ns014 ifconfig veth1415 up
...
ip netns exec ns015 ifconfig veth1516 up
...
ip netns exec ns016 ifconfig veth1617 up
...
ip netns exec ns017 ifconfig veth1718 up
...
ip netns exec ns018 ifconfig veth1819 up
...
ip netns exec ns019 ifconfig veth1920 up
...
ip netns exec ns020 ifconfig veth2021 up
...
ip netns exec ns021 ifconfig veth2122 up
...
ip netns exec ns022 ifconfig veth2223 up
...
ip netns exec ns023 ifconfig veth2324 up
...
ip netns exec ns024 ifconfig veth2425 up
...
ip netns exec ns025 ifconfig veth2526 up
...
ip netns exec ns026 ifconfig veth2627 up
...
ip netns exec ns027 ifconfig veth2728 up
...
ip netns exec ns028 ifconfig veth2829 up
...
ip netns exec ns029 ifconfig veth2930 up
...
ip netns exec ns030 ifconfig veth3031 up
...
ip netns exec ns031 ifconfig veth3132 up
...
ip netns exec ns032 ifconfig veth3233 up
...
ip netns exec ns033 ifconfig veth3334 up
